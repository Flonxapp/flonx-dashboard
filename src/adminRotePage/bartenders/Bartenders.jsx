...
import { useGetAllBartenderQuery, useUserBlockUnblockMutation } from "../../page/redux/api/admin/userApiAdmin";
  ...
  },
   {
      ...
      render: (_, record) => (
        <div className="flex gap-2 justify-end items-center">
          {/* Details */}
          <Link to={`/admin/dashboard/BartenderManagement/details/${record._id}`}>
